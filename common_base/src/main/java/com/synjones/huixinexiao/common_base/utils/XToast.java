...
public class XToast {
    ...
    private static Context context= Utils.getContext().getApplicationContext();
    ...
    public static Toast custom(@StringRes int message) {
        return custom( context.getResources().getText(message).toString(), null, DEFAULT_TEXT_COLOR, XOutdatedUtils.getColor(R.color.result_view), Toast.LENGTH_SHORT);
    }

    public static Toast custom(@NonNull String message) {
        return custom(message, null, DEFAULT_TEXT_COLOR, XOutdatedUtils.getColor(R.color.result_view), Toast.LENGTH_SHORT);
    }
