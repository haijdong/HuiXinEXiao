package com.synjones.huixinexiao.common_base.net;

import com.synjones.huixinexiao.common_base.app.AppConfig;
import com.synjones.huixinexiao.common_base.net.converter.GsonConverterBodyFactory;
import com.synjones.huixinexiao.common_base.net.interceptor.CaheInterceptor;
        ...
        if (retrofit == null) {
            synchronized (BaseRetrofit.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(Utils.getContext().getApplicationContext().getCacheDir(), "cache");
...
//                            .addInterceptor(new ParameterInterceptor(getRequestParams()))  //公共参数添加
                            .addInterceptor(new CaheInterceptor(Utils.getContext().getApplicationContext()))
